					...
					<c:forEach var="menuItem" items="${menuList}">
						<c:choose>
							<c:when test="${menuItem.getChildren().size() > 0}">
								<li class="dropdown"><a href="${menuItem.getLink()}" class="dropdown-toggle">${menuItem.getDescription()}&nbsp;<b class="caret"></b></a>
									<ul class="dropdown-menu">
										<c:forEach var="dropdownMenuItem" items="${menuItem.getChildren()}">
