...
<%@ tag import="com.smiechmateusz.model.Category" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ attribute name="categories" required="true" type="java.util.ArrayList" description="List of categories retrieved with CategoryDAO.getItemOffsetAlphabeticalList()" %>
...
<c:if test="${checked == null}">
	<% checked = new ArrayList<Category>(); %>
</c:if>
